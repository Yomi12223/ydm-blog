...
<img class="img-s" src="{{ 'assets/images/enosima.jpg' | relativePath }}" alt="江の島" width="250">
<br>
...
<img class="img-s" src="{{ 'assets/images/sumawatch.jpg' | relativePath }}" alt="腕時計" width="150">
